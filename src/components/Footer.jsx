    ...
    return(
        <div className={style.container}>
            ...
            <div className={style.Copy}>
                <p>™ &amp; © 2022 Riot Games Inc. Todos los derechos reservados. Riot Games, 
                    League of Legends y PvP.net son marcas comerciales, 
                    marcas de servicios o marcas registradas de Riot Games, Inc.</p>
            </div>
            <div className={style.Range}>
                <div className={style.ContentRange}>
                    <div className={style.ContentRange1}>
                        ...
                        <br/>
                        Temas insinuantes moderados
                        <br/>
                        Uso de alcohol y tabaco
                        <br/>
                        Interacciones en línea no clasificadas por la ESRB
                        <br/>
                        </div>
                    </div>
                </div>
